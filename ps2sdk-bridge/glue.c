...
static int          get_cube_points_count(void) { return cube_points_count; }
static u64          get_cube_black_rgbaq(void)  { return CUBE_BLACK_RGBAQ; }
static GSGLOBAL    *get_gs_global(void)         { return g_gsGlobal; }
